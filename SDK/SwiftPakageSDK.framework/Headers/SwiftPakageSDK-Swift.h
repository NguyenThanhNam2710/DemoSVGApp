...
#ifndef SWIFTPAKAGESDK_SWIFT_H
#define SWIFTPAKAGESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SwiftPakageSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP14SwiftPakageSDK10AnchorView_")
@protocol AnchorView
...
SWIFT_CLASS("_TtC14SwiftPakageSDK8DropDown")
...
@interface DropDown (SWIFT_EXTENSION(SwiftPakageSDK))
...
@interface DropDown (SWIFT_EXTENSION(SwiftPakageSDK)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC14SwiftPakageSDK12DropDownCell")
...
@interface DropDownCell (SWIFT_EXTENSION(SwiftPakageSDK))
- (void)awakeFromNib;
...
@interface UIBarButtonItem (SWIFT_EXTENSION(SwiftPakageSDK)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
...
@interface UIView (SWIFT_EXTENSION(SwiftPakageSDK)) <AnchorView>
@property (nonatomic, readonly, strong) UIView * _Nonnull plainView;
@end
